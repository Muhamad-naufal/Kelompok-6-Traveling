...
$sql = "SELECT * FROM kategori WHERE nama_kategori LIKE '%$pencarian%'";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) { ?>
                        <div class="row row-30 justify-content-center box-ordered">
                            ...
                            join daerah as d on t.id_daerah = d.id_nama_daerah where nama_kategori LIKE '%$pencarian%'  group by nama_kategori order by RAND()");
