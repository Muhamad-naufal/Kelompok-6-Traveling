<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $query = mysqli_query($connect, "SELECT * FROM traveling as t join daerah as d on t.id_daerah = d.id_nama_daerah join kategori as k on t.id_kategori = k.id_nama_kategori");
