        ...
        <div class="row g-5">
            ...
            <!-- <div class="col-lg-3 col-md-6">
                ...
                <div class="row g-2 pt-2">
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="assets/img/Kebunrayabogor.jpg" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="assets/img/kota tua.jpg" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="assets/img/tmii.jpg" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="assets/img/sari ater.jpg" alt="">
                    </div>
                    <div class="col-4">
            ...
            <div class="col-lg-3 col-md-6">
                <h4 class="text-white mb-3">Kritik dan Saran</h4>
                <div class="position-relative mx-auto" style="max-width: 400px;">
                    <input class="form-control border-primary w-100 py-3 ps-8 pe-5" type="text" placeholder="Tulis Kritik Saran Anda">
