            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="../public/assets/img/about.png" alt="" style="object-fit: cover;">
                    </div>
                </div>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0">Muhamad Fauzan Ansyori</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0">Anisa Sumayah</h5>
                            <small>Mahasiswa</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0">Muhamad Naufal</h5>
                            <small>Mahasiswa</small>
                        </div>
                    </div>
                </div>
